...
public class MedataParam {
    ...
    public String getAudiTm() {
        return audiTm;
    }

    public void setAudiTm(String audiTm) {
        this.audiTm = audiTm;
    }
    ...
    public String getMeTm() {
        return meTm;
    }

    public void setMeTm(String meTm) {
        this.meTm = meTm;
    }
