...
import vip.yingmen.entity.WrpFieldinfo;
import vip.yingmen.mapper.WrpFieldinfoMapper;
...
public class WrpFieldinfoServiceImpl extends ServiceImpl<WrpFieldinfoMapper, WrpFieldinfo> implements WrpFieldinfoService {
    ...
    //设备故障数据
    public List<Map<String,Object>> selectTroubleData(){ return wrpFieldinfoMapper.selectTroubleData();}
    //图像站点数据
