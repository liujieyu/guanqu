...
import vip.yingmen.mapper.ZhaFaShuiQingGISMapper;
...
@Service
public class ZhaFaShuiQingGISServiceImpl implements ZhaFaShuiQingGISService {
    @Autowired
    private ZhaFaShuiQingGISMapper zhaFaShuiQingGISMapper;

    //闸阀的gis第一滑框实时数据查询
    @Override
    public Map findByZhaFaShuiQingGIS(Map searchMap) {
//        System.out.println(searchMap.get("STGR"));
        ...
        List<ZhaFaShuiQingGIS> zhaFaShuiQingGISList = zhaFaShuiQingGISMapper.findByZhaFaShuiQingGISGIS(searchMap);
        List<ZhaFaShuiQingGIS> shuiQingGISList = new ArrayList<>();
        for (ZhaFaShuiQingGIS s:zhaFaShuiQingGISList){
        ...
        for (ZhaFaShuiQingGIS s : shuiQingGISList) {
...
//        System.out.println(searchMap.get("STGR"));
        ...
        map.put("fieldAliases", fieldAliases);
        map.put("geometryType", "esriGeometryPoint");
        List<ZhaFaShuiQingGIS> zhaFaShuiQingGISList = zhaFaShuiQingGISMapper.findByZhaFaShuiQingGISGIS();
        List<features> featuresList = new ArrayList<>();
        for (ZhaFaShuiQingGIS s : zhaFaShuiQingGISList) {
            features features = new features();
            attributes attributes = new attributes();
