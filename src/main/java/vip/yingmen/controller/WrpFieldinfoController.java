...
import vip.yingmen.entity.MedataParam;
...
public class WrpFieldinfoController {
    ...
    @RequestMapping(value="/troublechart",method = RequestMethod.GET)
    @ResponseBody
    public List<Map<String,Object>> troublechart(){
        return wrpFieldinfoService.selectTroubleData();
    }
    ...
    @RequestMapping(value="/waterraindata",method = RequestMethod.GET)
    @ResponseBody
    public Map<String,Object> waterraindata(AlarmParam alarmParam){
        Map<String,Object> map=new HashMap<String,Object>();
        map.put("raindata",wrpFieldinfoService.selectRainData(alarmParam));
        map.put("waterdata",wrpFieldinfoService.selectWlStcpDataByDate(alarmParam));
        return map;
    }
