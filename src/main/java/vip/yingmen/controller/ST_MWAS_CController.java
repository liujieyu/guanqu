...
@CrossOrigin
public class ST_MWAS_CController {
    @Autowired
    private ST_MWAS_CService stMwasCService;

    //闸阀水情gis第二滑框的月列表查询
    @GetMapping(value = "/table/View_ST_MWAS_C")
    public PageInfo<ST_MWAS_C> findBySingleYue(@RequestParam( value="_page", required=false,defaultValue = "1" ) Integer _page,
        ...
        return stMwasCService.findBySingleYue(_page,_page_size,STCD,_orderby,Time_min,Time_max);
    }
}
